...
# 创建组件使用tag属性
w.create_text(123,56, fill="red", text="I LOVE YOU", tag="fall")
# 创建的时候如果没有指定tag可以利用addtag_withtag添加
# 同类函数还有 addtag_all, addtag_above, addtag_xxx 等
id_rectangle = w.create_rectangle(56,78,173,100, fill="gray")
